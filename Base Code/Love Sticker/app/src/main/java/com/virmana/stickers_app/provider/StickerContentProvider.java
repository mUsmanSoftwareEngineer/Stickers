package com.virmana.stickers_app.provider;
...
public class StickerContentProvider extends ContentProvider {
    ...
    public List<StickerPack> getStickerPackList() {
       /* if (stickerPackList == null) {
        ...
        return (List)Hawk.get("whatsapp_sticker_packs",new ArrayList<StickerPack>());
    }
    ...
    private Cursor getStickerPackInfo(@NonNull Uri uri, @NonNull List<StickerPack> stickerPackList) {
        ...
        for (StickerPack stickerPack : stickerPackList) {
            ...
            builder.add("1");
            builder.add(1);
            builder.add(stickerPack.animatedStickerPack.equals( "true") ? 1 : 0);
        }
